...
public class AcercaDe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("MARTIN ERNESTO BARRÓN DOROTEO");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel6.setText("JOSE DE JESÚS RAMIREZ ORTEGA");
        ...
        jLabel11.setText("LENGUAJES Y AUTOMATAS II");

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel12.setText("DOCENTE");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel13.setText("MARIA ELENA PARRA URIAS");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Desktop.getDesktop().browse(new URI("https://github.com/JesusAlberto156/MATH3C.git"));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null,"ERROR, no se puede ejecutar la acción");
        }
